...
(() => {
  ...
  const DICT = {
    en: {
      ...
      'explorer.eyebrow': 'Interactive explorer',
      'explorer.h2': 'Turn the knobs. See the plan change.',
      'explorer.lede': 'Based on the full-year Case 3 campaign results. Each data point is an exact Gurobi solve; intermediate values are interpolated so you can explore the sensitivity surface continuously.',
      'explorer.betaLabel': 'Risk aversion β',
      'explorer.rn': 'RN',
      'explorer.cvar': 'CVaR',
      'explorer.pvLabel': 'PV cost γPV',
      'explorer.bessLabel': 'BESS cost γBESS',
      'explorer.mateLabel': 'MATE price',
      'explorer.note': 'MATER = 59, MATP = 15, PPAD spot = 16. Interpolated between campaign solve points.',
      'explorer.kpi1': 'Total cost',
      'explorer.kpi2': 'CAPEX',
      'explorer.kpi3': 'OPEX',
      'explorer.portfolioTitle': 'Portfolio mix',
      'explorer.costSplit': 'Cost split',
      'explorer.hedgeTitle': 'Physical hedge ratio',
      'explorer.hedge0': 'Contracts',
      'explorer.hedge100': 'Physical',
      'explorer.hedgeNote': 'PV self-consumption + BESS discharge as % of total supply.',
    ...
    es: {
      ...
      'hero.lede': 'STORM es una plataforma de optimización que estructura de forma conjunta la cartera de contratos de abastecimiento (MATER, MATE y MATP) y los activos de autogeneración y almacenamiento para Grandes Usuarios del Mercado Eléctrico Mayorista argentino (MEM). Valoriza el volumen de energía, el respaldo de potencia y la exposición a eventos extremos de precios (CVaR) como variables críticas de decisión, y no como meros ajustes contables a posteriori.',
      'hero.meta.1': 'MATER · MATE · MATP',
      ...
      'model.fan.demand.title': 'Curva de carga',
      'model.fan.spot.title': 'Precio spot de energía',
      'model.fan.pv.title': 'Producción FV',
      ...
      'mem.stack.local': 'VAD · 7%',
      'mem.legend.energy': 'Energía — MATER / MATE / spot',
      'mem.legend.power': 'Potencia — MATP / PPAD',
      'mem.legend.peaje': 'Peaje de distribución',
      'mem.legend.services': 'Servicios de Reserva de Confiabilidad + transporte',
      'mem.legend.local': 'VAD (valor agregado de distribución) + impuestos',
      'mem.card.mater.title': 'MATER',
      ...
      'found.eq2.title': 'Esperanza de cola con holguras auxiliares',
      ...
      'found.eq6.title': 'Compromiso mensual de contrato con margen de tolerancia TOP',
      ...
      'res.lede': 'Evaluado sobre el mismo abanico de 12 escenarios, STORM supera a los modelos de optimización parcial: solo contratos y solo DER resultan claramente peores que co-optimizar ambos frentes. Las decisiones de primera etapa con CVaR pagan una prima moderada en costo esperado a cambio de una cola de riesgo más controlada.',
      ...
      'apps.c5.title': 'Valuación de gestión de demanda en hora pico',
      ...
      'apps.c8.desc': 'Incorporar cualquier fuente de incertidumbre estructurada — hidrología, combustible, trayectoria de transición FRA (Factor de Renta Adaptado) — sin reescribir el modelo.',
      ...
      /* interactive explorer */
      'explorer.eyebrow': 'Explorador interactivo',
      'explorer.h2': 'Gira las perillas. Mira cómo cambia el plan.',
      'explorer.lede': 'Basado en los resultados de la campaña Caso 3 de año completo. Cada punto es una corrida exacta de Gurobi; los valores intermedios se interpolan para que puedas explorar la superficie de sensibilidad de forma continua.',
      'explorer.betaLabel': 'Aversión al riesgo β',
      'explorer.rn': 'RN',
      'explorer.cvar': 'CVaR',
      'explorer.pvLabel': 'Costo FV γFV',
      'explorer.bessLabel': 'Costo BESS γBESS',
      'explorer.mateLabel': 'Precio MATE',
      'explorer.note': 'MATER = 59, MATP = 15, PPAD spot = 16. Interpolado entre puntos de la campaña.',
      'explorer.kpi1': 'Costo total',
      'explorer.kpi2': 'CAPEX',
      'explorer.kpi3': 'OPEX',
      'explorer.portfolioTitle': 'Mezcla del portafolio',
      'explorer.costSplit': 'División de costos',
      'explorer.hedgeTitle': 'Autosuficiencia energética',
      'explorer.hedge0': 'Contratos',
      'explorer.hedge100': 'Físico',
      'explorer.hedgeNote': 'Autoconsumo FV + descarga BESS como % del suministro total.',
